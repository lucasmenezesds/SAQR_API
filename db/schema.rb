...
ActiveRecord::Schema.define(version: 20180318023959) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "api_v1_cargos", force: :cascade do |t|
    t.bigint "api_v1_truck_id"
    t.bigint "api_v1_delivery_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["api_v1_delivery_id"], name: "index_api_v1_cargos_on_api_v1_delivery_id"
    t.index ["api_v1_truck_id"], name: "index_api_v1_cargos_on_api_v1_truck_id"
  end
  ...
  add_foreign_key "api_v1_cargos", "api_v1_deliveries"
  add_foreign_key "api_v1_cargos", "api_v1_trucks"
