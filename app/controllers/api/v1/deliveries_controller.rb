class Api::V1::DeliveriesController < ApplicationController
  ...
  private
    ...
    def api_v1_delivery_params
      params.require(:api_v1_delivery).permit(:delivery_truck_id, :picking_time_id, :load_time_id, :transportation_time_id, :receive_time_id, :storage_time_id, :delivery_date)
    end
end
